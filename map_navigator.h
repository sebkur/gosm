...
#define GOSM_MAP_NAVIGATOR_CLASS(obj)     (G_TYPE_CHECK_CLASS_CAST ((obj), GOSM_MAP_NAVIGATOR, MapNavigatorClass))
#define GOSM_IS_MAP_NAVIGATOR(obj)        (G_TYPE_CHECK_INSTANCE ((obj), GOSM_TYPE_MAP_NAVIGATOR))
